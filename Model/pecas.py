...
df_csv['Data_Completa'] = (df_csv['Data'].astype(str) + '-' + df_csv['Mês'].astype(str) + '-' + df_csv['Ano'].astype(str))
...
df_csv = df_csv.drop(columns=['Data', 'Mês', 'Ano', 'Data_Completa'], errors='ignore')
